        ...
        <div class="panel-body">
           ...
           <div class="panel-body text-center">
            	<h2 class="text-danger">  
            		...
            		<span class="glyphicon"><a class="btn btn-primary btn-lg" target="_blank" onclick="queryBook()">查看我的已预约书籍</a></span>
...
<script type="text/javascript">
    ...
    function queryBook(){
    	...
    	window.location.href="<%=request.getContextPath()%>/books/appoint?studentId="+studentId;
    }
</script>
</html> 